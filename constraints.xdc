...
#	[Place 30-574] Poor placement for routing between an IO pin and BUFG. If this sub optimal condition is acceptable for this design, you may use the CLOCK_DEDICATED_ROUTE constraint in the .xdc file to demote this message to a WARNING. However, the use of this override is highly discouraged. These examples can be used directly in the .xdc file to override this clock rule.
    set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets display_IBUF]
    set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets load_IBUF]
    set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets f_inc_IBUF]
    set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets f_dec_IBUF]
...
#########
set_property PACKAGE_PIN T3 [get_ports freq[5]]
set_property IOSTANDARD LVCMOS33 [get_ports freq[5]]

set_property PACKAGE_PIN T2 [get_ports freq[4]]
set_property IOSTANDARD LVCMOS33 [get_ports freq[4]]

set_property PACKAGE_PIN R3 [get_ports freq[3]]
set_property IOSTANDARD LVCMOS33 [get_ports freq[3]]

set_property PACKAGE_PIN W2 [get_ports freq[2]]
set_property IOSTANDARD LVCMOS33 [get_ports freq[2]]

set_property PACKAGE_PIN U1 [get_ports freq[1]]
set_property IOSTANDARD LVCMOS33 [get_ports freq[1]]

set_property PACKAGE_PIN T1 [get_ports freq[0]]
set_property IOSTANDARD LVCMOS33 [get_ports freq[0]]
#########
set_property PACKAGE_PIN R2 [get_ports display]
...
# LED's
set_property PACKAGE_PIN L1 [get_ports LED_output[6]]
set_property IOSTANDARD LVCMOS33 [get_ports LED_output[6]]

set_property PACKAGE_PIN P1 [get_ports LED_output[5]]
set_property IOSTANDARD LVCMOS33 [get_ports LED_output[5]]

set_property PACKAGE_PIN N3 [get_ports LED_output[4]]
...
set_property PACKAGE_PIN U3 [get_ports LED_output[2]]
set_property IOSTANDARD LVCMOS33 [get_ports LED_output[2]]

set_property PACKAGE_PIN W3 [get_ports LED_output[1]]
set_property IOSTANDARD LVCMOS33 [get_ports LED_output[1]]

set_property PACKAGE_PIN V3 [get_ports LED_output[0]]
